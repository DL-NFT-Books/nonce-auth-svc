...
func UpdateUserByAddress(w http.ResponseWriter, r *http.Request) {
	...
	if err = helpers.DB(r).Users().FilterByAddress(request.Address).Update(request.Data.Attributes.Name); err != nil {

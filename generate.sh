...
GENERATED="${GOPATH}/src/gitlab.com/tokend/nft-books/nonce-auth-svc/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/tokend/nft-books/nonce-auth-svc/docs/web_deploy"
